...
export const paintPost = (userPost, idPost) => {
  ...
  const template = `
    ...
    <label id='likes-count'>Likes</label>
    <div class = "icon-comment-like"><i class="far fa-thumbs-up margin-left" id="icon-likes-count"></i><i class="far fa-comments margin-left"></i></div>
  ...
  // container.querySelector('#icon-likes-count').addEventListener('click', likesPostEvent);
  return container;
};
